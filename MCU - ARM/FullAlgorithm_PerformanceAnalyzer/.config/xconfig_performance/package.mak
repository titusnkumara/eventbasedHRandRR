...
override PKGDIR = xconfig_performance
...
package/%.xdc.inc package/%_xconfig_performance.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_performance" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em3 .dlls: performance.pem3

-include package/cfg/performance_pem3.mak
-include package/cfg/performance_pem3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/performance_pem3.dep
endif
performance.pem3: package/cfg/performance_pem3.xdl
	@


ifeq (,$(wildcard .libraries,em3))
performance.pem3 package/cfg/performance_pem3.c: .libraries,em3
endif

package/cfg/performance_pem3.c package/cfg/performance_pem3.h package/cfg/performance_pem3.xdl: override _PROG_NAME := performance.xem3
package/cfg/performance_pem3.c: package/cfg/performance_pem3.cfg
package/cfg/performance_pem3.xdc.inc: package/cfg/performance_pem3.xdl
package/cfg/performance_pem3.xdl package/cfg/performance_pem3.c: .interfaces

clean:: clean,em3
	-$(RM) package/cfg/performance_pem3.cfg
	-$(RM) package/cfg/performance_pem3.dep
	-$(RM) package/cfg/performance_pem3.c
	-$(RM) package/cfg/performance_pem3.xdc.inc

clean,em3::
	-$(RM) performance.pem3
.executables,em3 .executables: performance.xem3

performance.xem3: |performance.pem3

-include package/cfg/performance.xem3.mak
performance.xem3: package/cfg/performance_pem3.oem3 
	$(RM) $@
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M3 -z --strict_compatibility=on  -o $@ package/cfg/performance_pem3.oem3   package/cfg/performance_pem3.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
	
performance.xem3: export C_DIR=
performance.xem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)
performance.xem3: Path:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)

performance.test test,em3 test: performance.xem3.test

performance.xem3.test:: performance.xem3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 performance.xem3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.performance.xem3, ) 
endif

clean,em3::
	-$(RM) $(wildcard .tmp,performance.xem3,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
performance_pem3.oem3,copy : package/cfg/performance_pem3.oem3
performance_pem3.sem3,copy : package/cfg/performance_pem3.sem3

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_performance
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_performance.tar.dep
endif
package/rel/xconfig_performance/xconfig_performance/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_performance/xconfig_performance/package/package.rel.xml: package/build.cfg
package/rel/xconfig_performance/xconfig_performance/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_performance/xconfig_performance/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_performance.tar: package/rel/xconfig_performance.xdc.inc package/rel/xconfig_performance/xconfig_performance/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_performance.xdc.inc,package/rel/xconfig_performance.tar.dep)


release release,xconfig_performance: all xconfig_performance.tar
clean:: .clean
	-$(RM) xconfig_performance.tar
	-$(RM) package/rel/xconfig_performance.xdc.inc
	-$(RM) package/rel/xconfig_performance.tar.dep
